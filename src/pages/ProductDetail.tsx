...
export default function ProductDetail() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/30 to-pink-50/20 flex items-center justify-center">
  ...
  if (!product) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/30 to-pink-50/20 flex flex-col items-center justify-center gap-6">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-purple-50/30 to-pink-50/20">
      <header className="backdrop-blur-xl bg-white/80 border-b border-purple-100/50 sticky top-0 z-50">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="grid md:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="relative group">
            ...
            <div className="relative aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-purple-50 to-pink-50 shadow-2xl">
              <img 
                src={product.image} 
                alt={product.name} 
          ...
          <div className="flex flex-col gap-8">
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-purple-100 to-pink-100 rounded-full">
                ...
                <span className="text-sm font-medium text-purple-900">{product.seller_name}</span>
              </div>
              
              <h1 className="text-5xl font-bold leading-tight bg-gradient-to-r from-foreground via-purple-900 to-foreground bg-clip-text text-transparent">
                {product.name}
              </h1>
            ...
            <div className="space-y-6 p-8 bg-white rounded-3xl shadow-lg border border-purple-100">
