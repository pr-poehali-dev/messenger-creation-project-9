...
export const FRAMES: Frame[] = [
  ...
  },
  {
    ...
    style: {
      border: '10px solid',
      borderImage: 'linear-gradient(45deg, #E0F7FF, #FFFFFF, #B8E6FF, #FFFFFF, #E0F7FF) 1',
      boxShadow: '0 0 60px rgba(184, 230, 255, 1), 0 0 40px rgba(255, 255, 255, 0.9), inset 0 0 35px rgba(224, 247, 255, 0.6)',
    },
  },
  {
    id: 'frame-22',
    ...
    style: {
      border: '12px solid',
      borderImage: 'linear-gradient(90deg, #FF0000, #00FF00, #FFD700, #FF0000, #00FF00) 1',
      boxShadow: '0 0 70px rgba(255, 215, 0, 1), 0 0 50px rgba(255, 0, 0, 0.8), 0 0 30px rgba(0, 255, 0, 0.7), inset 0 0 40px rgba(255, 215, 0, 0.4)',
    },
  },
  {
    id: 'frame-23',
    ...
    style: {
      border: '9px solid',
      borderImage: 'linear-gradient(135deg, #FFFFFF, #C0E9FF, #E8F7FF, #C0E9FF, #FFFFFF) 1',
      boxShadow: '0 0 55px rgba(192, 233, 255, 1), 0 0 35px rgba(232, 247, 255, 0.9), inset 0 0 30px rgba(255, 255, 255, 0.5)',
    },
  },
  {
    id: 'frame-24',
    ...
    style: {
      border: '11px solid',
      borderImage: 'linear-gradient(45deg, #C41E3A, #FFD700, #FFFFFF, #FFD700, #C41E3A) 1',
      boxShadow: '0 0 75px rgba(196, 30, 58, 1), 0 0 55px rgba(255, 215, 0, 0.9), inset 0 0 40px rgba(255, 255, 255, 0.4)',
    },
  },
  {
    id: 'frame-25',
    ...
    style: {
      border: '10px solid',
      borderImage: 'linear-gradient(180deg, #F0F8FF, #B0D4E8, #FFFFFF, #B0D4E8, #F0F8FF) 1',
